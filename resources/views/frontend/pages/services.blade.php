...
<div class="container mt-5">
  ...
  <h3 class="text-dark text-center mt-4">Search any Services</h3>
    <form action="{{route('service.search')}}" method="get" class="mt-5 mb-5">
        <div class="form-group row">
          <div class="col-md-3">
       
           
          <select name="category_id" id="province" class="form-control" required>
...
@foreach($civil as $civil)
    <div class="col-md-4">
        <div class="card" style="width: 300px;">
            ...
            <h3 class="text-center text-danger">{{$civil->service_name}}</h3>
            <p>{!! substr(strip_tags($civil->description), 0, 200) !!}{{ strlen(strip_tags($civil->description)) > 200 ? '...' : '' }}</p>

            <a href="{{route('services.detail',$civil->id)}}">See Details</a>
        </div>
    </div>
@endforeach
...
<div class="owl-carousel">
    ...
    <div class="col-md-4">
        <div class="card" style="width: 300px;">
            ...
            <h3 class="text-center text-danger">{{$paint->service_name}}</h3>
            <p>{!! substr(strip_tags($paint->description), 0, 200) !!}{{ strlen(strip_tags($paint->description)) > 200 ? '...' : '' }}</p>
            <!-- <a href="">See Details</a> -->
            <a href="{{route('services.detail.paint',$paint->id)}}">See Details</a>
...
@if($plumbering->count() > 0)
    ...
    <div class="col-md-4">
        <div class="card" style="width: 300px;">
            ...
            <h3 class="text-center text-danger">{{$plumbering->service_name}}</h3>
            <p>{!! substr(strip_tags($plumbering->description), 0, 200) !!}{{ strlen(strip_tags($plumbering->description)) > 200 ? '...' : '' }}</p>
            <!-- <a href="">See Details</a> -->
            <a href="{{route('services.detail.plumber',$plumbering->id)}}">See Details</a>
...
@if($architect->count() > 0)
    ...
    <div class="col-md-4">
        <div class="card" style="width: 300px;">
            ...
            <h3 class="text-center text-danger">{{$architect->service_name}}</h3>
            <p>{!! substr(strip_tags($architect->description), 0, 200) !!}{{ strlen(strip_tags($architect->description)) > 200 ? '...' : '' }}</p>
            <!-- <a href="">See Details</a> -->
            <a href="{{route('services.detail.architect',$architect->id)}}">See Details</a>
...
@if($electrician->count() > 0)
    ...
    <div class="col-md-4">
        <div class="card" style="width: 300px;">
            ...
            <h3 class="text-center text-danger">{{$electrician->service_name}}</h3>
            <p>{!! substr(strip_tags($electrician->description), 0, 200) !!}{{ strlen(strip_tags($electrician->description)) > 200 ? '...' : '' }}</p>
            <!-- <a href="">See Details</a> -->
            <a href="{{route('services.detail.electrician',$electrician->id)}}">See Details</a>
...
@if($shuttering->count() > 0)
    ...
    <div class="col-md-4">
        <div class="card" style="width: 300px;">
            ...
            <h3 class="text-center text-danger">{{$shuttering->service_name}}</h3>
            <p>{!! substr(strip_tags($shuttering->description), 0, 200) !!}{{ strlen(strip_tags($shuttering->description)) > 200 ? '...' : '' }}</p>
            <!-- <a href="">See Details</a> -->
            <a href="{{route('services.detail.shuttering',$shuttering->id)}}">See Details</a>
