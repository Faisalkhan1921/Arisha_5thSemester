        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="card">
                    ...
                    <div class="">
                        <h2 class="text-center mt-2">Contact Technician</h2>
                        <form action="{{route('seeker.contact',$data1->id)}}" class="m-2" method="GET">
                            @csrf
                            ...
                            <div class="form-group">
                                ...
                                <input type="address" name="address" id="" class="form-control" required>
                            </div>
                            ...
                            <div class="fomr-group">
                                <input type="submit" value="Book Appoitment" class="btn btn-success form-control">
                            </div>
                        </form>
                    </div>
