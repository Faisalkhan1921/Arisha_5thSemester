    ...
    <div class="col-md-12 m-auto">
        <div class="card">
            ...
            <div class="card-body">
                ...
                @endif
                <form action="{{route('provider.services.update',$data1->id)}}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="form-group row">

                    <div class="col-md-4">
                        <label for="">Service Provider   Name</label>
                        <input type="text" name="service_name" id="" class="form-control" value="{{$data1->service_name}}">
                    </div>

                    <div class="col-md-4">
                        <label for="">Service Provider Phone</label>
                        <input type="number" name="service_provider_phone" id="" class="form-control" value="{{$data1->service_provider_phone}}">
                    </div>
            ...
            if (option.getAttribute('data-province') == selectedProvinceId || option.getAttribute('data-province') == '') {
                ...
                option.style.display = 'none';
                    ...
                    <div class="form-group">
                        <input type="submit" value="Update Service" class="form-control btn btn-success">
                    </div>
                </form>
            </div>
        </div>
