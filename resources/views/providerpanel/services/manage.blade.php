    ...
    <div class="col-md-12 m-auto">
        <div class="card">
            <div class="card-header">
                <h3 class="text-center text-danger">Services Data</h3>
            </div>
            ...
            <table class="table table-bordered">
                ...
                <tbody>
                    ...
                    <td style="font-size:12px;">{{$data->service_name}}</td>
                    <td style="font-size:12px;">{{$data->service_provider_phone}}</td>
                    ...
                    <td style="font-size:12px;">{{$data->featured}}</td>
                    <td style="font-size:12px;">{{$data->status}}</td>
                    <td>
                        <a href="{{route('provider.edit.service',$data->id)}}" class="btn btn-primary btn-sm">Edit</a>
                        <!-- <a href="{{route('provider.delete.service',$data->id)}}" class="btn btn-danger btn-sm" id="delete">Delete</a> -->
                        <a href="{{ route('provider.delete.service', $data->id) }}" class="btn btn-danger btn-sm" onclick="return confirm('Are you sure you want to delete this service?')">Delete</a>
